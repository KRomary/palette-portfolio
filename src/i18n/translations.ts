...
export const translations = {
  ...
  home: {
    ...
    greeting: { fr: "Salut, moi c'est", en: "Hey, I'm", es: "Hola, soy" },
    subtitle: { fr: "Ingénieur Data Science & BI", en: "Data Science & BI Engineer", es: "Ingeniero Data Science & BI" },
    description: {
    ...
    stats: {
      ...
      expDetail: { fr: "Alternance & stage international", en: "Apprenticeship & international internship", es: "Alternancia y prácticas internacionales" },
      ...
      toolsDetail: { fr: "VS Code, Power BI, GitHub…", en: "VS Code, Power BI, GitHub…", es: "VS Code, Power BI, GitHub…" },
  ...
  contact: {
    ...
    success: { fr: "Message envoyé avec succès !", en: "Message sent successfully!", es: "¡Mensaje enviado con éxito!" },
  },
  settings: {
    ...
    protanopiaDesc: { fr: "Difficulté à percevoir le rouge", en: "Difficulty perceiving red", es: "Dificultad para percibir el rojo" },
    deuteranopia: { fr: "Deutéranopie", en: "Deuteranopia", es: "Deuteranopía" },
    deuteranopiaDesc: { fr: "Difficulté à percevoir le vert", en: "Difficulty perceiving green", es: "Dificultad para percibir el verde" },
    tritanopia: { fr: "Tritanopie", en: "Tritanopia", es: "Tritanopía" },
    tritanopiaDesc: { fr: "Difficulté à percevoir le bleu", en: "Difficulty perceiving blue", es: "Dificultad para percibir el azul" },
